    ...
    send(obj){
        ...
        switch(typeof obj) {
            ...
            case "object":
                ...
                //Check to see if we have a json object OR HTML object
                // check json first then html
                if(obj.json) {
        ...
        //Set the status code
        // default to 200 if we haven't set one yet (checked against
        // undefined specifically, so an explicitly-set falsy code like 0
        // isn't mistaken for "unset" and clobbered)
        if(this.res.statusCode === undefined) this.res.statusCode = 200;
